...
import com.loki.tiktok.interfaces.ClipArtListener
import java.io.File

class OptiClipArtAdapter(clipArtList: ArrayList<String>, val context: Context, optiClipArtListener: ClipArtListener) :
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): MyPostViewHolder {
        return MyPostViewHolder(LayoutInflater.from(context).inflate(R.layout.clipart_view, p0, false))
    }
